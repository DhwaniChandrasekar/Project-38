...
function obstacles(){
    if(ruinsBgSp.x < 10){
        var obs = createSprite(random(400,2000),random(700,900),70,20)
        obs.velocityX = -6
        obsGroup.add(obs);
        obs.lifetime  = 2000/6;
        obs.scale = 0.5
...
function score(){
    if(ruinsBgSp.x < 10){
        ...
        points =  createSprite(random(400,2000),random(100,700),20,20)
...
function ev(){
    if(ruinsBgSp.x < 10){
        spawn = createSprite(random(400,2000),random(100,900),10,10)
        spawn.velocityX = -6
        evGroup.add(spawn);
...
function eevi(){
    if(ruinsBgSp.x <10){
        spawner = createSprite(random(400,2000),random(100,900),10,10)
        spawner.velocityX = -6
